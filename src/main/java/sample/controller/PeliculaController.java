...
public class PeliculaController {
	...
	public  Pelicula List(@PathVariable(name = "codigo", required = true) String cod) {
...
//	TIPO DE PELICULAS
	...
	public  Tipopelicula ListTipoPelicula(@PathVariable(name = "codigo", required = true) Integer cod) {
	...
	public void eliminarTipoPelicula(@PathVariable(name = "codigo", required = true) Integer cod) {
